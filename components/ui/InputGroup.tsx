...
type InputGroupProps = {
  ...
  className?: string;
  classGroup?: string;
  register?: any; // You may want to replace `any` with a more specific type depending on your form library
  name?: string;
  readonly?: boolean;
  value?: string;
  error?: any; // Replace with specific type based on your validation library
  icon?: ReactNode;
  disabled?: boolean;
  id?: string;
  horizontal?: boolean;
  validate?: any; // Replace with specific type based on your validation library
  isMask?: boolean;
  msgTooltip?: boolean;
  description?: string;
  hasicon?: boolean;
  ...
  append?: ReactNode;
  prepend?: ReactNode;
  options?: any; // Replace with a specific type for Cleave.js options
  onFocus?: () => void;
